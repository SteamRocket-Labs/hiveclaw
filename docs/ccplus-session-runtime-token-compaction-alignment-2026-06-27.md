...
1. FreeCode runnable baseline：`${LOCAL_HOME}/vc-saas/free-code-main`
2. claude-code-org cross-check：`${LOCAL_HOME}/Context Engineering/claude-code-org`
3. Codex Rust engineering delta：`${LOCAL_HOME}/Context Engineering/codex/codex-rs`
...
rg -n "applyToolResultBudget|snipCompactIfNeeded|microcompact|contextCollapse|autocompact|checkTokenBudget" \
  ${LOCAL_HOME}/vc-saas/free-code-main/src
...
rg -n "ContextWindowTokenStatus|run_inline_auto_compact_task|replace_compacted_history|AutoCompactWindow|start_new_context_window" \
  "${LOCAL_HOME}/Context Engineering/codex/codex-rs/core/src"
