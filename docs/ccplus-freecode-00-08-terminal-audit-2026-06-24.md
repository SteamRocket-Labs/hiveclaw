...
- `${LOCAL_HOME}/vc-saas/free-code-main/docs/00-architecture-overview.md`
- `${LOCAL_HOME}/vc-saas/free-code-main/docs/01-query-engine.md`
- `${LOCAL_HOME}/vc-saas/free-code-main/docs/02-tool-system.md`
- `${LOCAL_HOME}/vc-saas/free-code-main/docs/03-permission-system.md`
- `${LOCAL_HOME}/vc-saas/free-code-main/docs/04-context-management.md`
- `${LOCAL_HOME}/vc-saas/free-code-main/docs/05-state-and-ui.md`
- `${LOCAL_HOME}/vc-saas/free-code-main/docs/06-memory-system.md`
- `${LOCAL_HOME}/vc-saas/free-code-main/docs/07-subagents-and-teams.md`
- `${LOCAL_HOME}/vc-saas/free-code-main/docs/08-extensions.md`
