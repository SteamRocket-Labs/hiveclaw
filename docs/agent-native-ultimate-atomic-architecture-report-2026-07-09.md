...
| 对照物 | 本地路径 | HEAD | 用途 |
|---|---|---:|---|
| FreeCode | `${LOCAL_HOME}/vc-saas/free-code-main` | `7dc15d6c8fb0c40c7fcc02ce9b58204324252632` | CC 语义主基线 |
| Codex | `${LOCAL_HOME}/Context Engineering/codex` | `be33f80bc65159c094ecd06bf155afa3061ce23d` | 工程化、桌面端交互、沙箱和事件投影基线 |
| claw-code Python | `${LOCAL_HOME}/Context Engineering/claw-code` | `d229a9b022d4845d28a728677e6a6b7c22ec5a2e` | Python port 边界参考 |
| claude-code-org | `${LOCAL_HOME}/Context Engineering/claude-code-org` | `a99de1bb3c0c301b83b784abbcdb7a3674b2cd45` | CC 语义交叉校验 |
