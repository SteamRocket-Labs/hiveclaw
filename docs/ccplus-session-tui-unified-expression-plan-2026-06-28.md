...
- `${LOCAL_HOME}/vc-saas/free-code-main/src/commands.ts`
- `${LOCAL_HOME}/vc-saas/free-code-main/src/components/messages/CompactBoundaryMessage.tsx`
- `${LOCAL_HOME}/vc-saas/free-code-main/src/components/StatusLine.tsx`
...
- `${LOCAL_HOME}/vc-saas/free-code-main/src/commands/branch/branch.ts:61`
- `${LOCAL_HOME}/vc-saas/free-code-main/src/commands/branch/branch.ts:122`
- `${LOCAL_HOME}/vc-saas/free-code-main/src/commands/branch/branch.ts:274`
- `${LOCAL_HOME}/vc-saas/free-code-main/src/components/MessageSelector.tsx:328`
- `${LOCAL_HOME}/vc-saas/free-code-main/src/screens/REPL.tsx:3659`
- `${LOCAL_HOME}/vc-saas/free-code-main/src/screens/REPL.tsx:3674`
- `${LOCAL_HOME}/vc-saas/free-code-main/src/screens/REPL.tsx:3715`
- `${LOCAL_HOME}/vc-saas/free-code-main/src/cli/print.ts:573`
- `${LOCAL_HOME}/vc-saas/free-code-main/src/cli/print.ts:736`
- `${LOCAL_HOME}/vc-saas/free-code-main/src/cli/print.ts:4520`
- `${LOCAL_HOME}/vc-saas/free-code-main/src/utils/fileHistory.ts:347`
- `${LOCAL_HOME}/vc-saas/free-code-main/src/main.tsx:991`
- `${LOCAL_HOME}/vc-saas/free-code-main/src/cli/print.ts:5105`
...
- `${LOCAL_HOME}/Context Engineering/codex/codex-rs/tui/src/bottom_pane/snapshots/codex_tui__bottom_pane__command_popup__tests__command_popup_default_items.snap`
- `${LOCAL_HOME}/Context Engineering/codex/codex-rs/tui/src/bottom_pane/snapshots/codex_tui__bottom_pane__approval_overlay__tests__approval_overlay_permissions_prompt.snap`
- `${LOCAL_HOME}/Context Engineering/codex/codex-rs/tui/src/bottom_pane/snapshots/codex_tui__bottom_pane__footer__tests__footer_active_agent_label.snap`
- `${LOCAL_HOME}/Context Engineering/codex/codex-rs/app-server-protocol/schema/typescript/v2/ThreadForkResponse.ts`
- `${LOCAL_HOME}/Context Engineering/codex/codex-rs/app-server-protocol/schema/typescript/v2/ThreadRollbackResponse.ts`
- `${LOCAL_HOME}/Context Engineering/codex/codex-rs/app-server-protocol/schema/typescript/v2/CollabAgentTool.ts`
- `${LOCAL_HOME}/Context Engineering/codex/codex-rs/app-server-protocol/schema/typescript/v2/PermissionsRequestApprovalParams.ts`
