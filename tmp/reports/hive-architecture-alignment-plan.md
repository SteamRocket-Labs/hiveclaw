...
- Validation report: terminal RuntimeTask status must match latest progress; completed tasks need output or verification evidence; skipped/failed/killed tasks need explicit reason
...
- Validation report: promoted candidates require source attempts, eval reward/baseline, traces, rollback_ref, and zero critical regressions
- Rollback event: rollback itself is ledgered as `evolution_rollback_event.v1`
...
**文档版本**:v2.2 · 2026-04-27 · H4/H5 验证报告补齐
