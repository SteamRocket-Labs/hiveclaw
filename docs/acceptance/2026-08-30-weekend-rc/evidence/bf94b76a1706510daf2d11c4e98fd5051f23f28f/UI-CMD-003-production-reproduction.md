...
- Production: `https://service-3.example.invalid`
...
- Agent: EventPilot `00000016-0000-4000-8000-000000000000`
- Fresh synthetic Session: `00000454-0000-4000-8000-000000000000`
...
3. Entered `/usage`. The only result was `Command usage completed. session_id=00000454-0000-4000-8000-000000000000`; no token/cost/budget panel opened and an internal Session ID was exposed in the ordinary chat surface.
4. Entered `/permissions`. The only result was `Command permissions completed. session_id=00000454-0000-4000-8000-000000000000`; no effective-permission/approval/restriction panel opened and the same internal ID was exposed.
