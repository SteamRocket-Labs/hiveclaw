...
| 模型循环/kernel | ● | ● | ● | ● | ● | ● | ● |
| Web chat 会话生命周期 | ● | ● | ● | ● | ● | ● | ● |
| 工具治理平面 | ● | ◐(GV-08) | ◐(GV-08) | ● | ◐(GV-01/03 真 PG 待补) | ● | ○(GV-08 fake-pin 测试；GV-01/02/03/09 真 PG 待补) |
