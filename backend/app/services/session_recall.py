    ...
    try:
        ...
        try:
            for hit in hits:
                ...
                prompt = (
                    "Summarize this recalled past session for the current query in 1-2 concise sentences.\n"
                    "Focus on what was decided, what was produced, and any concrete artifact or file path.\n"
