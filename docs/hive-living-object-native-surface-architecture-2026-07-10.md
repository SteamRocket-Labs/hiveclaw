...
- ${LOCAL_HOME}/vc-saas/agent-native/packages/core/docs/content/agent-surfaces.mdx
- ${LOCAL_HOME}/vc-saas/agent-native/packages/core/docs/content/native-chat-ui.mdx
- ${LOCAL_HOME}/vc-saas/agent-native/packages/core/docs/content/generative-ui.mdx
- ${LOCAL_HOME}/vc-saas/agent-native/packages/core/src/client/chat/tool-render-registry.tsx
- ${LOCAL_HOME}/vc-saas/agent-native/packages/core/src/action-ui.ts
- ${LOCAL_HOME}/vc-saas/agent-native/templates/content/actions/update-content-database-view.ts
- ${LOCAL_HOME}/vc-saas/agent-native/templates/content/app/components/editor/database/
- ${LOCAL_HOME}/vc-saas/agent-native/templates/slides/actions/create-deck.ts
- ${LOCAL_HOME}/vc-saas/agent-native/templates/slides/actions/patch-deck.ts
- ${LOCAL_HOME}/vc-saas/agent-native/templates/slides/app/components/deck/SlideRenderer.tsx
...
- `${LOCAL_HOME}/.codex/plugins/cache/openai-bundled/visualize/1.0.11/skills/visualize/SKILL.md`；
- `${LOCAL_HOME}/.codex/plugins/cache/openai-bundled/visualize/1.0.11/skills/visualize/scripts/render.py`；
