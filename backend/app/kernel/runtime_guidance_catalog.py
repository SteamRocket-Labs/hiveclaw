...
HIVE_NATIVE_GUIDANCE_CATALOG: tuple[HiveNativeGuidanceEntry, ...] = (
    ...
    _hive(
        ...
        "runtime/hooks.py STOP / TURN_STOP / TURN_ABORT",
        "internal_hook_event",
        "STOP can govern continuation; TURN_STOP/TURN_ABORT seal T0, not prompt injection.",
    ),
    _hive(
        "hook_subagent_stop",
        "hook",
    ...
    _hive(
        ...
        "hook",
        AlignmentStatus.NOT_APPLICABLE,
        "Session end/fallback close",
        "runtime/hooks.py SESSION_END / SESSION_CLOSE",
        "internal_hook_event",
        "SESSION_CLOSE is fallback consolidation; normal turns use TURN_STOP.",
    ),
    _hive(
        "hook_pre_compact",
        "hook",
