...
- `${LOCAL_HOME}/vc-saas/free-code-main/src/tools/EnterPlanModeTool/EnterPlanModeTool.ts`
- `${LOCAL_HOME}/vc-saas/free-code-main/src/utils/messages.ts`
- `${LOCAL_HOME}/vc-saas/free-code-main/src/tools/ExitPlanModeTool/ExitPlanModeV2Tool.ts`
...
- `${LOCAL_HOME}/Context Engineering/codex/codex-rs/collaboration-mode-templates/templates/plan.md`
- `${LOCAL_HOME}/Context Engineering/codex/codex-rs/utils/stream-parser/src/proposed_plan.rs`
- `${LOCAL_HOME}/Context Engineering/codex/codex-rs/core/src/session/turn.rs`
- `${LOCAL_HOME}/Context Engineering/codex/codex-rs/core/src/tools/handlers/plan.rs`
