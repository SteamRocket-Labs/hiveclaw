# 外部行为 Eval CI 设计（历史档案）

> **状态(2026-07-02)**:本设计已被 `eval-system-spec.md`(v1)**取代**,降为历史档案,不再是实施依据。E1-E10 资产的保留/删除处置见新 spec §3;取代原因(实验室形态错置、合成场景信息量趋零、gate-first 守空管道、nightly 结构性 502 全红)见新 spec §0 与 2026-07-02 eval 讨论轮。
