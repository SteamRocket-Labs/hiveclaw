...
async def run_skill_distillation_cycle(
    *,
    ...
    """Delegate to the single run_skill_distillation lifecycle owner."""
    import sys
    from app.services.skill_distillation_runner import run_skill_distillation

    return await run_skill_distillation(
        agent_id=agent_id,
        workspace=workspace,
        tenant_id=tenant_id,
        ...
        factor_session_provider=factor_session_provider,
