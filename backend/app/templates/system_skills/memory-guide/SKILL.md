...
- The fact is a transient task detail, intermediate tool output, or debug note — belongs in `focus.md` or a workspace file, not memory.
...
→ Also remove any focus.md todo that required auto-cleanup.
```
