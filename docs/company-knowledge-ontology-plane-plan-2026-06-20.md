...
> 2026-07-14 重基线：本文保留 2026-06-20 时点的 provider 调研、Ontology 原始推理和 canonical Markdown ingestion 背景。其 Graphiti 默认、SAG 平行必接、prompt/Runtime automatic injection、`org|team` scope、Phase 0-5 与旧 `/enterprise/knowledge-base` 替换路径均已被覆盖。  
> 当前 Company Knowledge 唯一专项规格：`docs/company-knowledge-base-spec-2026-07-07.md`。  
> 当前跨层架构：`docs/knowledge-substrate-plugin-architecture-2026-07-09.md`。  
> 当前 runtime：`docs/personal-company-knowledge-tool-boundary-2026-07-10.md`。

本文后续出现的“当前选型决定”“默认 provider”“实施阶段”“prompt injection”等措辞只表示历史设计快照，不表示当前系统状态或待执行计划。
