...
This repository is public. Keep exact production identifiers, personal information, billing details, host-local paths, and raw operational evidence in restricted storage. Public records use anonymous identifiers and variable paths, marked as redacted where needed; keep their source commits, observed outcomes, and limitations unchanged. Generated agent state, session logs, personal memory, private attachments, and temporary reports stay untracked. Review linked documents and media as well as the edited page before publication.
