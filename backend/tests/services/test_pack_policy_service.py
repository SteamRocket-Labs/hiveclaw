...
def test_policy_pack_names_include_manifest_owned_tools_only():
    ...
    assert "web_pack" in policy_pack_names_for_tool("advanced_web_search")
    assert "web_pack" in policy_pack_names_for_tool("advanced_web_fetch")
    assert "web_pack" in policy_pack_names_for_tool("exa_search")
    assert "web_pack" in policy_pack_names_for_tool("exa_fetch")
    assert "web_pack" in policy_pack_names_for_tool("tavily_search")
    assert "web_pack" in policy_pack_names_for_tool("tavily_extract")
    ...
    assert "web_pack" in policy_pack_names_for_tool("firecrawl_search")
