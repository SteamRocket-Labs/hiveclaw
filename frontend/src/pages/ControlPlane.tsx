...
const CONTROL_PLANE_CARDS: ControlPlaneCard[] = [
  ...
  },
  {
    ...
    description: 'Tool registry, MCP servers, plugins, connectors, and tenant-level capability installs.',
    icon: <IconPlugConnected size={18} stroke={1.6} />,
    group: 'runtime',
  },
  {
    tab: 'subagents',
    to: '/enterprise/subagents',
    title: 'Team & Delegation',
    description: 'Company subagent library, delegation primitives, and A2A/team governance boundary.',
    icon: <IconRoute size={18} stroke={1.6} />,
    group: 'governance',
  },
  {
    tab: 'memory',
    ...
    description: 'Memory retention, hygiene, governed write policy, and enterprise knowledge controls.',
  ...
  },
  {
    ...
    description: 'Company profile, enterprise knowledge files, notification broadcasts, and integration identity.',
  ...
  {
    tab: 'skills',
    to: '/enterprise/skills',
    title: 'Assets & Automation',
    description: 'Skill registry, skill files, automation assets, and governed capability packages.',
  ...
  },
  {
    ...
    description: 'User-scoped local runtime presence, local workspace, direct channel chat, and Hive Bridge pairing.',
