...
| CC-06-24 | 提取 agent canUseTool 沙箱 | hive-native 映射 | heartbeat SOP-driven 40 轮，仅 stage T3 不直写（`heartbeat.py:41/102/589-611`）；Platform Gate commit；write_gate 全程 |
