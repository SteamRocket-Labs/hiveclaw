      ...
      <div className="session-runtime-list">
        {decisions.map((decision) => (
          <article key={decision.id} className="session-runtime-decision">
            ...
            {onFeedback ? (
              <div className="session-runtime-actions" aria-label={t('sessionWorkbench.rightPanel.decisionFeedback', 'Decision feedback')}>
                <button
                  type="button"
...
export function SessionRuntimePanel({
  ...
  sessionDecisions?: SessionDecisionTrace[];
  onDecisionFeedback?: (
    decision: SessionDecisionTrace,
