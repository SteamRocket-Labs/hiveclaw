...
def test_background_subagent_dispatch_and_completion_never_fall_back_to_agent_creator() -> None:
    ...
    assert "enqueue_completion_notification(" in run_source
    assert not (ROOT / "services" / "subagent_wake_consumer.py").exists()
