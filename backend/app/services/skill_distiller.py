...
async def _draft_skill_with_llm(
    *,
    ...
    system_prompt = (
        ...
        "Do not convert objectives into skills. Do not convert wake policies\n"
        "into skills. Do not convert focus.md rows, Runtime Task ids,\n"
        "Attempt ids, objective ids, trigger ids, schedules, or artifacts\n"
        "into skills. If the evidence is only a current goal or a schedule,\n"
        "choose reject or defer.\n"
        "</autonomy_boundary>\n\n"
        "<decision_matrix>\n"
