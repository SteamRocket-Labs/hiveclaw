...
- 本地对标项目：
  - Claude Code / CC：`${LOCAL_HOME}/vc-saas/free-code-main`，commit `7dc15d6`。
  - Hermes：`${LOCAL_HOME}/vc-saas/hermes-agent`，commit `75643a615`。
  - Codex：`${LOCAL_HOME}/Context Engineering/codex`，commit `9f4fac8ec4`。
