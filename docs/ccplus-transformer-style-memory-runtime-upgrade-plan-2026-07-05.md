...
| I-02 | TURN_STOP 汇总本轮 activation feedback | `runtime/hooks_setup.py`、`runtime/invoker.py` | turn stop tests | 已完成：本提交；Red：`pytest tests/runtime/test_t0_to_t2_session_close.py::test_t0_to_t2_hook_plan_uses_projection_not_legacy_extract tests/runtime/test_t0_to_t2_session_close.py::test_turn_stop_summarizes_activation_feedback_before_t0_seal -q` 先失败于无法导入 `_summarize_activation_feedback_on_turn_stop`；Green：`pytest tests/runtime/test_invoker.py::test_invoke_agent_emits_response_complete_and_session_close_hooks tests/runtime/test_t0_to_t2_session_close.py::test_t0_to_t2_hook_plan_uses_projection_not_legacy_extract tests/runtime/test_t0_to_t2_session_close.py::test_turn_stop_summarizes_activation_feedback_before_t0_seal tests/runtime/test_fast_reflection_hook.py::test_memory_hook_plan_registers_fast_reflection_handler -q` -> 4 passed；Lint：`ruff check app/runtime/hooks_setup.py app/runtime/invoker.py tests/runtime/test_t0_to_t2_session_close.py tests/runtime/test_fast_reflection_hook.py` -> All checks passed |
| I-03 | 用户 feedback 回流 heat/decay sidecar | `services/session_feedback.py`、`activation_events.py` | feedback tests | 已完成：本提交；Red：`pytest tests/services/test_session_feedback.py::test_record_session_feedback_writes_activation_heat_decay_sidecar -q` 先失败于缺少 `heat_decay_sidecar`；Green targeted -> 1 passed；周边回归：`pytest tests/services/test_session_feedback.py tests/runtime/test_activation_events.py -q` -> 9 passed；Lint：`ruff check app/services/session_feedback.py tests/services/test_session_feedback.py` -> All checks passed |
