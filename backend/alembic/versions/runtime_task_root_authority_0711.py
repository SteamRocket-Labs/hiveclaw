...
def upgrade() -> None:
    ...
    op.create_index("ix_runtime_tasks_root_user_id", "runtime_tasks", ["root_user_id"])
    op.create_index("ix_runtime_tasks_root_session_id", "runtime_tasks", ["root_session_id"])
    op.create_index(
        "ix_runtime_tasks_root_authority",
        "runtime_tasks",
        ["tenant_id", "parent_agent_id", "root_user_id", "root_session_id"],
    )
