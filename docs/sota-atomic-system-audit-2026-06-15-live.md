...
- 本地对标项目（commit 与读码版一致 → 参考代码未变）：
  - CC / Claude Code：`${LOCAL_HOME}/vc-saas/free-code-main` `7dc15d6`
  - Hermes（须达到/超过的 lean benchmark）：`${LOCAL_HOME}/vc-saas/hermes-agent` `75643a615`
  - Codex：`${LOCAL_HOME}/Context Engineering/codex` `9f4fac8ec4`
