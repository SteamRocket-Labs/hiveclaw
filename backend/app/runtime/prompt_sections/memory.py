...
### Layers
- **T0** (`memory/t0/sessions/<session_id>/segments/<segment_id>/events.jsonl` + `source.md`): append-only portable Memory evidence ledger, 30-day retention. JSONL is the evidence truth; Markdown/XML is the readable projection. Cloud run recovery uses committed `ChatTranscriptEvent` rows first.
