...
- 本地对标项目：CC/Claude Code `${LOCAL_HOME}/vc-saas/free-code-main`；Hermes（须达到/超过的 lean benchmark）`${LOCAL_HOME}/vc-saas/hermes-agent`；Codex `${LOCAL_HOME}/Context Engineering/codex`。
