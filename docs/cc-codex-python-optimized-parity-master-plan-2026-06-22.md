...
1. FreeCode baseline：`${LOCAL_HOME}/vc-saas/free-code-main`
2. CC TS cross-check：`${LOCAL_HOME}/Context Engineering/claude-code-org`
3. claw-code Python direction：`${LOCAL_HOME}/Context Engineering/claw-code/src`
4. claw-code Rust runtime：`${LOCAL_HOME}/Context Engineering/claw-code/rust`
5. Codex delta：`${LOCAL_HOME}/Context Engineering/codex/codex-rs`
6. Hive implementation：`${REPO_ROOT}`
