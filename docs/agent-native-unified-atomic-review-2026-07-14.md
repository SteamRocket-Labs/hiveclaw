...
- 对应 §12.2 canonical 行已更新为 `in_progress-production-dry-run:EVID-G1-005`；该证据初次写入时 Group 1 仍有 14 个 leaf 未闭环。当前滚动状态只以 §9 与 §12.3 为准；103 分母、severity、Group owner 与 5 个 Missing 均不变。
