...
| B-03 | 定义 `ActivationEvent` / feedback schema | `backend/app/runtime/activation_events.py` | `tests/runtime/test_activation_events.py` | 已完成：本提交；Red `pytest tests/runtime/test_activation_events.py -q` -> 3 failed / ModuleNotFoundError；Green -> 3 passed, 4 third-party warnings；Lint `ruff check app/runtime/activation_events.py tests/runtime/test_activation_events.py` -> All checks passed |
