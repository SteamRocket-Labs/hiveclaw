...
| B-01 | 定义 `ActivationQuery` schema | `backend/app/runtime/activation_query.py` | `tests/runtime/test_activation_query.py` | 已完成：本提交；Red `pytest tests/runtime/test_activation_query.py -q` -> 3 failed / ModuleNotFoundError；Green -> 3 passed, 4 third-party warnings；Lint `ruff check app/runtime/activation_query.py tests/runtime/test_activation_query.py` -> All checks passed |
