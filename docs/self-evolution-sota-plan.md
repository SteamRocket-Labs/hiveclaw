...
| P4: Skill Flywheel v2 | Completed 2026-05-23 | `backend/app/services/skill_flywheel.py`; fast reflection workflow/repeated/loaded-skill signals can create inactive skill candidate drafts under `evolution/skill_candidates/<candidate_id>/SKILL.md`; candidate records carry `skill_candidate_manifest.v1`, static skill guard result, progressive disclosure metadata, and verification eval; active `skills/` is not mutated. `skill_guard.py` now blocks embedded tenant/user/agent/workspace identifiers in generated skills in addition to secrets/binary/path escape checks. Tests: `pytest tests/services/test_skill_flywheel.py tests/services/test_skill_guard.py -q` -> 7 passed; regression: `pytest tests/services/test_skill_flywheel.py tests/services/test_skill_guard.py tests/services/test_skill_lifecycle.py tests/services/test_skill_distiller.py tests/services/test_evolution_verification.py tests/services/test_fast_reflection_candidate.py -q` -> 34 passed; ruff passed for changed P4 files. |
