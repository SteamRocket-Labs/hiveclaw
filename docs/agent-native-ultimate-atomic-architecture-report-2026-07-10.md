...
| 对象 | 本地路径 | 当前提交 | 用途 |
|---|---|---|---|
| Hive | `${REPO_ROOT}` | `512200142c247922566afb6497dee67febc1c2f2` | 被审计系统 |
| CC / FreeCode | `${LOCAL_HOME}/vc-saas/free-code-main` | `7dc15d6c8fb0c40c7fcc02ce9b58204324252632` | CC 可运行语义基线，优先级最高 |
| Codex | `${LOCAL_HOME}/Context Engineering/codex` | `be33f80bc65159c094ecd06bf155afa3061ce23d` | 工程、协议、沙箱、线程与桌面交互增量 |
| Hive Connect | `${LOCAL_HOME}/vc-saas/hive-connect` | `20718e629be1a1d506aa366a526bff245edd8277` | Local Agent / Bridge 基线 |
